...
def calc_sia_prob_from_rand_eff(sia_re, sia_cover=0.5, sia_scale=1.0):
    """Convert SIA random effects to probabilities."""
    vals_rescaled = sia_scale * sia_re + np.log(sia_cover / (1 - sia_cover))  # Center & scale the random effects
